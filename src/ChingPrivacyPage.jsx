...
import ChingFooter from './components/ChingFooter'
import ChingNav from './components/ChingNav'
...
const privacySections = [
  {
    ...
    paragraphs: [
      ...
      'ching does not require you to create an account, does not track your location, and does not harvest your personal information. Your "chill sessions," focus data, and pet collection progress belong entirely to you.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'ching offers In-App Purchases (such as the ching PRO Lifetime unlock). All payment transactions are processed securely by Apple via the App Store. We do not process, receive, or have access to your credit card information, billing details, or Apple ID credentials.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'The App may contain links to our official website or external social media platforms for support and community purposes. Please note that if you click on a third-party link, you will be directed to that site.',
  ...
  },
  {
    ...
    paragraphs: [
      'ching does not knowingly collect any personal information from children under the age of 13 (or 16 in certain jurisdictions), as we do not collect personal information from anyone.',
    ],
  },
  {
      ...
      <section className="hero-section privacy-hero">
        <div className="content-shell privacy-shell">
          ...
          <div className="privacy-header">
            ...
            <p>
              Welcome to ching! We built this app to be a safe, stress-free
              digital sanctuary. Because we believe in true relaxation, we have
              designed ching with a strict privacy-first approach.
            </p>
            <p>
              This Privacy Policy explains how we handle your data when you use
              the ching mobile application (&quot;the App&quot;) and our official website.
            </p>
          </div>
        </div>
      </section>
...
export default ChingPrivacyPage
