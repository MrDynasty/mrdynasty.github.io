...
const termsSections = [
  {
    ...
    content: (
      <>
        <p>
          ching is a lifestyle and relaxation timer designed to help you
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          ching is an entertainment and digital wellbeing tool. While it uses
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          ching offers premium features through In-App Purchases, including
          ching PRO Lifetime, monthly subscriptions, or consumable tips.
        </p>
        <ul>
          <li>
  ...
  },
  {
    ...
    content: (
      <p>
        All content within ching, including but not limited to the digital
        pet artwork, animations, UI/UX design, Chill Cards, and soundscapes,
        are the exclusive property of ching Studio and are protected by
        copyright laws.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        We respect your privacy immensely. ching is designed to operate
        without collecting your personal data. Please refer to our{' '}
        <a href="/ching-privacy.html">Privacy Policy</a> for more details.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        To the maximum extent permitted by law, ching Studio shall not be
      ...
      <section className="hero-section terms-hero">
        <div className="content-shell terms-shell">
          ...
          <div className="terms-header">
            ...
            <p>
              Welcome to ching! These Terms of Use (&quot;Terms&quot;) govern
              your use of the ching mobile application (&quot;the App&quot;)
              operated by ching Studio (&quot;we&quot;, &quot;us&quot;, or
              &quot;our&quot;).
            </p>
            <p>
